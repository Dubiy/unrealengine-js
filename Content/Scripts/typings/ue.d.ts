...
declare class EditorLevelFolders extends UObject { 
	static Load(ResourceName: string): EditorLevelFolders;
	static Find(Outer: UObject, ResourceName: string): EditorLevelFolders;
	static GetDefaultObject(): EditorLevelFolders;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EditorLevelFolders;
	static C(Other: UObject | any): EditorLevelFolders;
}

declare class TileLODEntryDetails { 
	LODIndex: number;
	RelativeDistance: number;
	SimplificationDetails: LevelSimplificationDetails;
	clone() : TileLODEntryDetails;
	static C(Other: UObject | any): TileLODEntryDetails;
}

declare class WorldTileDetails extends UObject { 
	bTileEditable: boolean;
	PackageName: string;
	ParentPackageName: string;
	position: IntVector;
	AbsolutePosition: IntVector;
	ZOrder: number;
	bHideInTileView: boolean;
	NumLOD: number;
	LOD1: TileLODEntryDetails;
	LOD2: TileLODEntryDetails;
	LOD3: TileLODEntryDetails;
	LOD4: TileLODEntryDetails;
	static Load(ResourceName: string): WorldTileDetails;
	static Find(Outer: UObject, ResourceName: string): WorldTileDetails;
	static GetDefaultObject(): WorldTileDetails;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): WorldTileDetails;
	static C(Other: UObject | any): WorldTileDetails;
}
